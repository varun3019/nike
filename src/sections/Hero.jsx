const Hero = () => {
  return (
    <section className =" display:hidden relative w-full h-full max-lg:hidden max-md:hidden ">
      <div className=" absolute mt-20 ml-[650px] max-lg:ml-[240px] mb-[200px]"> <p className="font-mono ml-8 max-md:text-[40px] mt-3 italic  max-lg:text-[50px] ">Save Up to 40%</p>
